define(['jquery', 'bootstrap', 'setup', 'twitter', 'portfolio', 'testimonials', 'jqueryvalidate', 'google-maps', 'paginated-items', 'blog', 'contact','mailchimp-form'], function($) {
	$(function() {
		// Activate twitter
		var tweets = $('.tweets');
		if (tweets.length > 0){
